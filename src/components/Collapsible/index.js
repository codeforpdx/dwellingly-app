...
function Collapsible(props) {
  ...
  return (
    <div
      className={`collapsible ${isCollapsed && 'isCollapsed'} ${
        !countAsNumber && 'isDisabled'
      }`}>
      <div className="collapsible__header">
        ...
        <button className="collapsible__toggle" onClick={toggleCollapsed}>
          <span className="icon">
            <i className="fas fa-chevron-down"></i>
          </span>
        </button>
      </div>
      {countAsNumber ? children : <></>}
    </div>
  );
}
