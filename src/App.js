...
export class App extends React.Component {
  ...
  refreshJwtPeriodically = () => {
    auth
      .refreshAccess(window.localStorage["dwellinglyRefresh"])
      .then((response) => {
        this.setState(
          {
            userSession: {
  ...
  updateAxiosDefaults = () => {
    axios.defaults.headers.common[
      "Authorization"
    ] = `Bearer ${this.state.userSession.accessJwt}`;
  };
      ...
      >
        <BrowserRouter>
          <div className="App">
            ...
            {this.state.userSession.isAuthenticated && <Footer />}
          </div>
        </BrowserRouter>
        <ToastContainer
