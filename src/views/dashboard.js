...
export const Dashboard = (props) => {
  ...
  const handleStaffAssignment = () => {
    ...
    axios
      .all(tenantUpdateReqs)
      .then(
        axios.spread((...responses) => {
          const stillUnstaffed = unstaffedTenants.filter((tenant) => {
            const isTenantUnchanged = !responses.find(
              ({ data }) => data.id === tenant.id
            );
        ...
        <div className="dashboard__main_container">
          <div className="dashboard__main">
            ...
            <div className="dashboard__modules_container">
              <DashboardModule data={MODULE_DATA.openTickets} />
              <DashboardModule data={MODULE_DATA.reports} />
              <DashboardModule data={MODULE_DATA.managers} />
            </div>
            <Collapsible
              ...
              <div className="dashboard__assignments_container">
                ...
                <div className="dashboard__assignments_button_container">
                  <button
                    className={`${
                      areStaffAssigned && 'active'
                    } dashboard__save_assignments_button button is-rounded`}
            ...
            <Collapsible title="Request for Access" count={usersPending.length}>
