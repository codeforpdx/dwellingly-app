    ...
    <>
      ...
      <p className="control has-icons-left search-bar">
        <input
          ...
          type="text"
          placeholder="Search properties"></input>
...
export const JoinStaffOptions = () => {
  return (
    <label className="checkbox make-admin-padding">
      <span className="admin-check-padding">Make Admin</span>
...
export const RoleDropDown = () => {
  ...
  const [viewPropertyManagerOptions, setPropertyManagerOptions] = useState(
    false
  );
  ...
  const bottomPad = viewPropertyManagerOptions
    ? 'bottom-padding-property'
    : viewJoinStaffOptions
    ? 'bottom-padding-join'
    : 'bottom-padding';
  const dropDown = 'dropdown is-rounded ' + (isActive ? 'is-active' : '');
  const dropButton =
    'icon is-small ' +
    (viewPropertyManagerOptions
      ? 'drop-button-prop'
      : viewJoinStaffOptions
      ? 'drop-button-join'
      : 'drop-button-start');
    ...
    <div className={bottomPad}>
      <div className={dropDown}>
        <div className="dropdown-trigger">
          <button
            className="button is-rounded drop-button"
            aria-haspopup="true"
        ...
        <div className="dropdown-menu dropdown-menu-place">
          <div className="dropdown-content dropdown-content-width">
            <DropDownItem
              dropContent="JOIN Staff"
              clickHandle={handleClickJOIN}
            />
            <DropDownItem
              dropContent="Property Manager"
              clickHandle={handleClickProperty}
            />
          </div>
        </div>
      </div>
    ...
    <>
      <div className="request-page">
        ...
        <div className="button-padding">
          ...
          <button
            className="button has-background-grey has-text-white is-rounded is-small cancel-button has-text-weight-bold"
