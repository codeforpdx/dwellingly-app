...
const EmergencyContact = ({
  ...
  const handleContactEdit = () =>
    isEditing && history.push(`/edit/emergencycontact/${id}`);

  return (
    <div className="emergencyContact__row">
      {isEditing && (
        <div
          className="emergencyContact__delete_action"
          onClick={handleContactDelete}>
          <i className="fas fa-minus-circle icon"></i>
        </div>
      )}
      <div
        className={`emergencyContact__main_column ${isEditing ? 'active' : ''}`}
    ...
    <div className="emergency_contacts__container">
      <div className="section-header">
        <div className="page-title">
          ...
          <div className="rounded" onClick={handleStartEditing}>
      ...
      {editMode && (
        <div className="section-footer">
          <button
            className="active button is-rounded"
