                        ...
                        <div className="form-container add-emergency-contact__main_container">
                            <Form className="add-emergency-contact__form-container" onSubmit={handleSubmit}>
                                    ...
                                    render={numbersArrayFields => {
                                        ...
                                        return(
                                            <>
                                                ...
                                                <div className="form-add-rows-container" onClick={resizeInputs}>
                                ...
                                <div className="container-footer">
                                    ...
                                    <button className={`button is-dark is-rounded ${resize}`} onClick={() => history.push('/emergency')} type="button">
                                        CANCEL
                                    </button>
                                </div>
                            </Form>
