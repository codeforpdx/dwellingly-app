...
export class Tenants extends Component {
    ...
    // getTenants = (context) => {
    //     axios.get(`${process.env.REACT_APP_API_URL}/tenants`, { headers: {"Authorization" : `Bearer ${context.user.accessJwt}`} })
    //     .then((response) => {
                  ...
                  return (
                      <div className="properties__container">
                          ...
                          <div className="search-section">
                              <input class="input search is-rounded" placeholder="Search Tenants by name, property, or JOIN staff"></input>
                            </div>
