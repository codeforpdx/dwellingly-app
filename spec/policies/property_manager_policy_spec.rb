...
RSpec.describe PropertyManagerPolicy, type: :policy do
  subject(:policy) { described_class.new(user, property_manager) }

  let(:user)             { build(:admin) }
  let(:property_manager) { build(:property_manager) }
